...
/**
 * This plugin has been modified for Strings.
 */
...
class AuditableBehavior extends ModelBehavior {
  ...
  public function afterSave( Model $Model, $created ) {
    ...
    if(method_exists($Model,'_auditDescription')){
      $data['Audit']['description'] = $Model->_auditDescription($audit,$operation,$updates);
    }
  ...
  public function afterDelete( Model $Model ) {
    ...
    if(method_exists($Model,'_auditDescription')){
      $data['Audit']['description'] = $Model->_auditDescription($audit,'delete');
    }

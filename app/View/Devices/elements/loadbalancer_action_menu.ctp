<?php
    ...
    $actionMenu .= $this->Strings->oldModalLink('Manage Nodes',"/Devices/manageNodes/$deviceId",$actionsDisabled);
    //$actionMenu .= $this->Strings->oldModalLink('Configure',"/Devices/configure/$deviceId",$actionsDisabled);
